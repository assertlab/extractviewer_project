...
/**
 * Representa as chaves de mensagens de erro nas realizações de casos de uso da entidade {@link SelecaoEstudo}.
 * 
 * @author helaine.lins
 * @created 05/05/2014 - 18:18:23
 */
public enum SelecaoEstudoErroEnum implements IEnumErro {

    ERRO_CONFIGURACAO_SELECAO_OBRIGATORIA("SelecaoEstudo.erro.configuracaoSelecaoObrigatoria"),
    ERRO_REVISOR_OBRIGATORIO("SelecaoEstudo.erro.revisorObrigatorio"),
    ERRO_SELECAO_ANTERIOR_OBRIGATORIA("SelecaoEstudo.erro.selecaoInicialObrigatoria"),
    ERRO_SELECAO_ANTERIOR_INEXISTENTE("SelecaoEstudo.erro.selecaoInicialInexistente");
     ...
     */
    private SelecaoEstudoErroEnum(String codigo) {
        this.codigo = codigo;
    }

...
/**
 * Representa a definição da camada de acesso a dados da entidade {@link EstudoSecundario} .
 * 
 * @author helaine.lins
 * @created 18/08/2014 - 18:28:46
 */
public interface IEstudoSecundarioDAO extends IDao<EstudoSecundario> {

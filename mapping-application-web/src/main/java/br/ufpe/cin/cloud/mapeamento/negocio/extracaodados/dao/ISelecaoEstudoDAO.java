...
/**
 * Representa a definição da camada de acesso à dados da entidade {@link SelecaoEstudo}.
 * 
 * @author helaine.lins
 * @created 18/08/2014 - 14:41:26
 */
public interface ISelecaoEstudoDAO extends IDao<SelecaoEstudo>{

    boolean existeSelecaoEstudo(Long idSelecao);

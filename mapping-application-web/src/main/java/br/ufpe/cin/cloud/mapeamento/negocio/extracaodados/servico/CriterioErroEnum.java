...
/**
 * Representa as chaves de mensagens de erro nas realizações de casos de uso da entidade {@link Criterio}.
 * 
 * @author helaine.lins
 * @created 05/05/2014 - 18:18:23
 */
public enum CriterioErroEnum implements IEnumErro {

    ERRO_DESCRICAO_OBRIGATORIA("Criterio.erro.descricaoNaoInformada");
     ...
     */
    private CriterioErroEnum(String codigo) {
        this.codigo = codigo;
    }
